...
dir_taxa = os.path.join(dir_out, 'PROCESSING' ,'7_Readstaxonomy')
...
rule all:
    input:
        ...
        os.path.join(dir_reports, "all_kraken2_unclassified.txt"),
        os.path.join(dir_reports, "taxa_all_kraken2_genus.tsv")
