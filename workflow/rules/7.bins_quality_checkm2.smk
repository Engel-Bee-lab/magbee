...
rule bins_checkm2_dastool_individual:
    input:
        bins_dir = os.path.join(dir_binning, "das_tool", "dastool_DASTool_bins.done")
    output:
        checkm2_dir = os.path.join(dir_reports, "checkm2_all", "CheckM2_DASTool_quality_report.tsv")
    params:
